...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-8 relative overflow-hidden animate-fade-in">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold tracking-tight">NFT Gateway</h1>
        ...
        <Card className="glass border-none shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Enter your information to access the NFT minting experience
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          className="bg-white/50 backdrop-blur-sm border-primary/20 focus:border-primary/50"
                          {...field} 
                        />
                      </FormControl>
                      <FormMessage />
